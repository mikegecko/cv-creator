    ...
    <div className="App-text App-info">
      <div className="wrapper">
        ...
        <div className="container">
          <form className="info" onSubmit={props.infoSubmit}>
            <div className="form">
              <input
                type="text"
                id="name"
              ...
              {props.skills.map((el, index) => {
                return (
                  <div className="skilldiv" key={index}>
                    <input name="skillin" onChange={(event) => props.handleSkillChange(index,event)}></input>
                    <button className="sbutton" onClick={() => props.removeSkillField(index)}>
                      <span className="material-icons md-12">remove</span>
                    </button>
                  </div>
                );
              })}
              <button className="sbutton" onClick={props.addSkill}>
